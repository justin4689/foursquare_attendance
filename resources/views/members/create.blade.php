                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('members.store') }}" class="space-y-4">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="phone" name="phone" type="tel" class="block mt-1 w-full" placeholder="07 78 54 13 55" inputmode="numeric" maxlength="14" pattern="[0-9]{2} [0-9]{2} [0-9]{2} [0-9]{2} [0-9]{2}" title="Format: 07 78 54 13 55 (10 chiffres)" />
                        ...
                        <div id="permanent-fields" class="space-y-4">
                            <div>
                                ...
                                <x-text-input id="lieu_habitation" name="lieu_habitation" type="text" class="mt-1 block w-full" :value="old('lieu_habitation')" placeholder="{{ __('Ex: Abidjan, Yopougon') }}" />
                            ...
                            <div>
                                ...
                                <x-text-input id="anniversaire_jour_mois" name="anniversaire_jour_mois" type="text" class="mt-1 block w-full" :value="old('anniversaire_jour_mois')" placeholder="{{ __('JJ/MM (ex: 05/11)') }}" inputmode="numeric" maxlength="5" pattern="\d{2}/\d{2}" title="JJ/MM" />
