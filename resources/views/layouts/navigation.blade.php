        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('pointage.intelligent')" :active="request()->routeIs('pointage.intelligent')">
                        {{ __('Pointage') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('cultes.index')" :active="request()->routeIs('cultes.*')">
                        {{ __('Cultes') }}
                    </x-nav-link>
